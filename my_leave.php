<?php
// my_leave.php  (shared by employees + managers)
session_start();
...
// Only allow employee or manager here
if (!in_array($role, ['employee', 'manager'], true)) {
    header("Location: login.php");
    exit;
}

// Decide where the "Back" button goes
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($leave_type === "" || $start_date === "" || $end_date === "") {
        $errors[] = "Please choose a leave type and start/end dates.";
...
// Load this person’s leave requests
$stmt = $mysqli->prepare("
