...
// All holidays + theme days for this month
...
<head>
    <meta charset="UTF-8">
    <title>Icy Phoenix – Company Calendar</title>
...
<div class="container">
    <header class="top-bar">
        <h1>Company Calendar – <?php echo htmlspecialchars($ceo_name); ?></h1>
    ...
    <div class="card">
        ...
        <p class="hint-text">
            This calendar shows all <strong>Icy Phoenix company holidays</strong>, 
            <strong>standard holidays</strong>, and <strong>fun theme days</strong>.
        </p>
